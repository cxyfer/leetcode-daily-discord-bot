# similar-result-details Specification

## Purpose
Define when similar-result responses can expose direct problem-detail entry buttons and when they must fail closed to embed-only.
